...
# ARG_DEFAULTS_POS()
# ARG_HELP([Marlin firmware for Flashforge],[Script to build & flash MarlinV2 firmware on Flashforge printers])
# ARGBASH_GO()
...
print_help()
{
	printf '%s\n' "Marlin firmware for Flashforge"
	...
	printf '\t%s\n' "-h, --help: Prints help"
	printf '\n%s\n' "Script to build & flash MarlinV2 firmware on Flashforge printers"
}
