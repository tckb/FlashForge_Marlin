...
#define CASE_LIGHT_ENABLE
  ...
  #define CASE_LIGHT_PIN    500 /* dummy value */              // Override the default pin if needed
...
#define LCD_SHOW_E_TOTAL
  ...
  #define SHOW_REMAINING_TIME       // Display estimated time to completion
     ...
     // You can use Octoprint like software to send out more accurate remaining time
